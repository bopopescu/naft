...
#mycursor.execute("CREATE TABLE arazi (id INTEGER AUTO_INCREMENT PRIMARY KEY , sharh VARCHAR (255) , mablaghe_darkhasti_naftanir VARCHAR(255) , mablaghe_hoghooghi VARCHAR(255),tarikh_hoghooghi VARCHAR(255),mablaghe_taeed_mali VARCHAR(255),tarikh_taeed_omoor_mali VARCHAR(255))")
...
mycursor.execute("CREATE TABLE pipeline_30_inch (id INTEGER AUTO_INCREMENT PRIMARY key , estelam_1 VARCHAR(255) , estelam_2 VARCHAR(255) , estelam_3 VARCHAR(255))")
