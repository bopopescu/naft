...
mycursor.execute("CREATE TABLE arazi (id INTEGER AUTO_INCREMENT PRIMARY KEY , sharh VARCHAR (255) , mablaghe_darkhasti_naftanir VARCHAR(255) , mablaghe_hoghooghi VARCHAR(255),tarikh_hoghooghi VARCHAR(255),mablaghe_taeed_mali VARCHAR(255),tarikh_taeed_omoor_mali VARCHAR(255),tarikh VARCHAR(255))")
...
mycursor.execute("CREATE TABLE sadid_mahshahr ( money varchar(255), tik varchar(255))")
